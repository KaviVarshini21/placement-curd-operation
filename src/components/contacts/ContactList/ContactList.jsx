                    ...
                    <div key={m._id}>
                                 ...
                                 <div className="col-md-6">
                                         ...
                                         <div className=' fw-bold'>
                                            Company Name : <span className='fw-bold text-primary'>{m.company}</span>
                                         </div>
                                         <div className=' fw-bold'>
                                             Trainer Name : <span className='fw-bold text-primary'>{m.trainername}</span>
                                         </div>
                                         <div className=' fw-bold'>
                                             Department : <span className='fw-bold text-primary'>{m.dept}</span>
                                         </div>
                                         <div className=' fw-bold'>
                                             Date : <span className='fw-bold text-primary'>{m.date}</span>
                                         </div>
